var kwKyKzLaLbLcLiLkLrLsLtLuLvLyMaMcMdMeMfMgMhMkMlMmMnMoMpMqMrMsMtMuMvMwMxMyMzNaNcNeNfNgNiNlNoNpNrNuNzOmPaPePfPg = {
  "KW": {
    "fmt": "%N%n%O%n%A%n%Z %C",
    "id": "data/KW",
    "key": "KW",
  ...
  "MX": {
    ...
    "languages": "es",
    "name": "MEXICO",
    "posturl": "http://www.correosdemexico.gob.mx/lservicios/servicios/Descarga.aspx",
    "require": "ACZ",
    "state_name_type": "state",
...
export default kwKyKzLaLbLcLiLkLrLsLtLuLvLyMaMcMdMeMfMgMhMkMlMmMnMoMpMqMrMsMtMuMvMwMxMyMzNaNcNeNfNgNiNlNoNpNrNuNzOmPaPePfPg;
